...
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    private Orientations.Orientation orientation;
    ...
    private void initFromXml(AttributeSet attr) {
        ...
        int orientation_int = a.getInteger(R.styleable.CardContainer_orientation, 1);
        setOrientation(Orientations.Orientation.fromIndex(orientation_int));
