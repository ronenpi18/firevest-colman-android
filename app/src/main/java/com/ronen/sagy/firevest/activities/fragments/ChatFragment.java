...
public class ChatFragment extends Fragment {
    ...
    private String[] messages = {"hey", "Juste par habitude en tout cas", "Hey!", "6946743263", "Give me your number, I will call you"};
    private int[] counts = {0, 3, 0, 0, 1};
    private int[] messagePictures = {R.drawable.startup_1, R.drawable.startup_2, R.drawable.startup_3};
    private int[] likePictures = {R.drawable.startup_1, R.drawable.startup_2};
    private String[] messageNames = {"Veego", "Ermetic", "Snyk"};
    private String[] likeNames = {"Veego", "Ermetic"};
